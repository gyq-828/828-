...
import { BookOpen, Code, FileText, ChevronRight, CheckCircle, XCircle, Play, Lightbulb, Award, BarChart3, Database, Brain, TrendingUp, Target, Layers, Cpu, Network, Shield, Zap, RefreshCw, RotateCcw, ExternalLink, GitBranch, Sparkles } from 'lucide-react'
import CodeMirror from '@uiw/react-codemirror'
import { python } from '@codemirror/lang-python'

type TabType = 'theory' | 'practice' | 'visualization'
  ...
  const renderPracticeTab = () => (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">12个阶梯式实训项目，从基础到进阶，支持在线编程和自动评分</p>
      </div>
      ...
      {activeSection === 'projects' && renderProjectList()}
  ...
  const renderVisualizationTab = () => (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="text-center mb-12">
        ...
        <h1 className="text-4xl font-bold text-gray-900 mb-4">聚类算法可视化</h1>
        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          交互式演示 KMeans、DBSCAN、层次聚类三种算法，直观理解聚类原理
        </p>
      </div>
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl shadow-xl p-8 text-white mb-12">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex-1">
            <h2 className="text-2xl font-semibold mb-3">开始你的可视化探索之旅</h2>
            <p className="text-lg opacity-90 mb-4">
              通过交互式可视化工具，动态观察聚类算法的执行过程，深入理解算法原理。
            </p>
            <div className="flex flex-wrap gap-3">
              <span className="px-3 py-1 bg-white bg-opacity-20 rounded-full text-sm">
                🎯 KMeans
          ...
          <Link
            to="/cluster-visualizer"
            className="px-8 py-4 bg-white text-purple-600 font-semibold rounded-full hover:bg-purple-50 transition-colors duration-300 shadow-lg hover:shadow-xl flex items-center justify-center text-lg"
          >
            <span className="mr-2">🎯</span>
            打开可视化工具
      ...
      <h2 className="text-2xl font-bold text-gray-900 mb-6">算法介绍</h2>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        <div className="bg-white rounded-xl shadow-lg p-6 border border-blue-100 hover:shadow-xl transition-shadow duration-300">
          ...
          <h3 className="text-xl font-bold text-gray-900 mb-3">KMeans</h3>
          <p className="text-gray-600 mb-4">
            基于距离的划分聚类算法，将数据划分为K个簇，每个簇由其质心代表。简单高效，适合球状簇。
          </p>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 border border-green-100 hover:shadow-xl transition-shadow duration-300">
          ...
          <h3 className="text-xl font-bold text-gray-900 mb-3">DBSCAN</h3>
          <p className="text-gray-600 mb-4">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 border border-purple-100 hover:shadow-xl transition-shadow duration-300">
          ...
          <h3 className="text-xl font-bold text-gray-900 mb-3">层次聚类</h3>
          <p className="text-gray-600 mb-4">
            自底向上的聚合聚类算法，生成树状的层次结构，可通过截断树确定簇数。
          </p>
          <ul className="space-y-2 text-sm text-gray-600">
            <li className="flex items-start">
      ...
      <div className="bg-white rounded-2xl shadow-lg p-8 border border-blue-100">
        <h2 className="text-2xl font-bold text-gray-900 mb-6">可视化工具特色</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="text-center">
            <div className="w-16 h-16 bg-blue-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
              <Play className="w-8 h-8 text-blue-600" />
            </div>
            <h3 className="font-semibold text-gray-900 mb-2">动态演示</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="font-semibold text-gray-900 mb-2">多种算法</h3>
            <p className="text-sm text-gray-600">
              支持6种主流聚类算法，对比学习效果更佳
            </p>
          </div>
          <div className="text-center">
            ...
            <h3 className="font-semibold text-gray-900 mb-2">参数调节</h3>
            <p className="text-sm text-gray-600">
              自由调整算法参数，观察对结果的影响
            </p>
          </div>
          <div className="text-center">
            ...
            <h3 className="font-semibold text-gray-900 mb-2">多种数据集</h3>
            <p className="text-sm text-gray-600">
              提供不同难度的数据集，满足各种学习场景
            </p>
          </div>
